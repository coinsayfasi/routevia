...
List<_FeatureRow> _buildFeatureRows(BuildContext context) => [
  ...
  _FeatureRow(Icons.route_outlined, context.tr('Süreye göre plan ve rota optimizasyonu', 'Time-based plans and route optimization'), context.tr('Açık', 'Open'), context.tr('Açık', 'Open')),
  _FeatureRow(Icons.keyboard_return, context.tr('Dönüş saatimi koru (dönüş yolu + 15 dk pay, mutlaka görülecek durak)', 'Protect my return time (return trip + 15 min buffer, must-see stop)'), context.tr('Kilitli', 'Locked'), context.tr('Açık', 'Open')),
