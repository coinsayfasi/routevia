with upserted as (
  ...
  values (
    ...
    '2026-03-13T09:00:08.736Z'::timestamptz,
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:10.109Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:14.365Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:15.749Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:17.117Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:18.492Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:19.961Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:21.386Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:22.839Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:24.244Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:25.624Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:29.153Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:30.558Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:34.886Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:36.330Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:00:37.774Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
