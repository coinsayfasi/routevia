with upserted as (
  ...
  values (
    ...
    '2026-03-13T09:01:44.682Z'::timestamptz,
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:01:45.956Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:01:49.161Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:01:50.442Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:01:51.708Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:01:52.974Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:01:54.245Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:01:55.513Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:01:57.103Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:01:58.367Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:01:59.632Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:02:02.165Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:02:03.429Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:02:07.661Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:02:08.933Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
...
with upserted as (
  ...
  values (
    ...
    96,
    'admin_verified'::public.coordinate_source_kind,
    '2026-03-13T09:02:10.205Z'::timestamptz,
    'must_see_backfill_script'
  )
  on conflict (province_id, slug) do update
  set
